...
public class PDFViewSkinES extends PDFViewSkin {
    ...
    private HBox createSearchNavigator() {
        ...
        searchLabel.textProperty().bind(Bindings.createObjectBinding(() -> "Encontradas " + view.getSearchResults().size() + " ocurrencias en " + pageSearchResults.size() + " páginas", view.getSearchResults(), pageSearchResults));
